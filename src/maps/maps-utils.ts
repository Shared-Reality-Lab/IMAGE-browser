...
function processMap(port: any, map: any){
...
export function processIMAGEMaps(document: Document, port: browser.Runtime.Port){
    Array.from(document.getElementsByTagName("iframe")).forEach((map) => processMap(port, map));
}

export function processIMAGEMAPImages(document: Document, port: browser.Runtime.Port){
    Array.from(document.getElementsByTagName("img")).forEach((map) => processMap(port, map));
}
